  ...
  return s.jsx("span", {
    ...
    children:
      e.kind === "ring"
        ...
        : s.jsx("img", {
            src: B(`assets/logos/${e.id}.${e.ext || "webp"}`),
            alt: `${e.name} logo`,
            loading: "eager",
            decoding: "async",
            draggable: !1,
            style: { opacity: e.opt != null ? Math.min(1, e.opt) : 1 },
          }),
  });
}
            ...
            s.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  s.jsx("span", { className: "name", children: i.name }),
                ],
              },
              i.id,
            ),
      ...
      children: [
        ...
        n.length > 0 &&
          s.jsx("span", {
            ...
            "aria-hidden": "true",
            children: "Double-click to clear",
          }),
      ],
    })
  );
...
const ds = () => [
  ...
  os = () => [
    ...
    ["ok", "ten years, and they all rhyme"],
  ],
  hs = [
    ...
    children: s.jsxs("div", {
      ...
      children: [
        ...
        s.jsx("article", {
          ...
          children: s.jsxs("p", {
            children: ["Empty state?", s.jsx("br", {}), "ask design"],
          }),
        }),
        s.jsxs("article", {
          className: "pane chat",
          children: [
            ...
            s.jsx("p", {
              className: "me",
              children: s.jsx("i", {
                children: "make the rail crop the second card",
              }),
            }),
            s.jsxs("div", {
              className: "ai",
              children: [
                ...
                s.jsx("p", {
                  className: "r1",
                  children: "On it — a 24px reveal on the second.",
                }),
                s.jsx("p", {
                  className: "r2",
                  children: "Editing WorkRail.tsx",
                }),
              ],
            }),
          ],
        ...
        s.jsxs("span", {
          ...
          children: [
            ...
            s.jsx("i", { className: "tag", children: "Pleurat" }),
          ],
        }),
      ],
    }),
        ...
        s.jsxs("article", {
          ...
          children: [
            ...
            s.jsx("p", {
              className: "me",
              children: s.jsx("i", {
                children: "/sena build the Badge component",
              }),
            }),
            s.jsxs("div", {
              className: "ai",
              children: [
                ...
                s.jsx("p", {
                  className: "r1",
                  children: "Reading the registry — 12 parts, 3 pending.",
                }),
                s.jsx("p", {
                  className: "r2",
                  children: "Handing off to the squad",
                }),
              ],
            }),
          ],
              ...
              children: [
                s.jsxs("li", {
                  ...
                  children: [
                    s.jsx("i", {}),
                    " Plan",
                    s.jsx("em", { children: "scope + variants" }),
                  ],
                }),
                s.jsxs("li", {
                  className: "s2",
                ...
                s.jsxs("li", {
                  ...
                  children: [
                    s.jsx("i", {}),
                    " Check",
                    s.jsx("em", { children: "WCAG AA, contrast" }),
                  ],
                }),
                s.jsxs("li", {
                  className: "s4",
                  children: [
                    s.jsx("i", {}),
                    " Ship",
                    s.jsx("em", { children: "docs + registry" }),
                  ],
                }),
              ],
            }),
          ...
          children: [
            ...
            s.jsxs("div", {
              ...
              children: [
                s.jsx("span", {
                  className: "cl",
                  children: "agents: 11 · tools: mcp",
                }),
                s.jsx("span", {
                  className: "cl add a1",
                  children: "✓ badge.tsx + badge.css",
                }),
                s.jsx("span", {
                  className: "cl add a2",
                  children: "✓ contrast 4.9:1 — AA",
                }),
                s.jsx("span", {
                  className: "cl",
                  children: "registry updated",
                }),
              ],
            }),
            s.jsx("span", { className: "save", children: "1.4s" }),
          ],
        }),
        s.jsxs("svg", {
          className: "flow",
          ...
          children: [
            ...
            s.jsxs("div", {
              ...
              children: [
                ...
                s.jsx("span", {
                  className: "cl add a2",
                  children: "✓ 12 components rebuilt",
                }),
      ...
      children: [
        s.jsxs("article", {
          ...
          children: [
            ...
            s.jsx("p", {
              className: "me",
              children: s.jsx("i", {
                children: "drivers can't find the next pickup",
              }),
            }),
            s.jsxs("div", {
              className: "ai",
              children: [
                ...
                s.jsx("p", {
                  className: "r1",
                  children: "14 interviews · 3 patterns",
                }),
                s.jsx("p", {
                  className: "r2",
                  children: "Route first, list second",
                }),
              ],
            }),
          ],
        ...
        s.jsxs("article", {
          ...
          children: [
            ...
            s.jsx("span", {
              className: "lbl2",
              children: "v3 · after the third round",
            }),
          ],
        }),
        s.jsxs("article", {
    ...
    [d, S] = r.useState([
      {
        id: 0,
        kind: "note",
        text: "the portfolio — type `help`, or press a key below",
      },
    ]),
    [b, P] = r.useState(!1),
    [R, H] = r.useState([]),
