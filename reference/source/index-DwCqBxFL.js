const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "assets/index-D8zjrZIf.js",
      "assets/index-Di0mkZEe.css",
    ]),
) => i.map((i) => d[i]);
  ...
  Pe = () => {
    window.va ||
      (window.va = function (...a) {
        (window.vaq || (window.vaq = []), window.vaq.push(a));
      });
  },
  Ce = "@vercel/analytics",
  Re = "2.0.1";
...
function De() {
  return (de() ? window.vam : ce()) || "production";
}
function q() {
...
function _e(e) {
  return e.scriptSrc
    ...
    : q()
      ...
      : e.basePath
        ? P(`${e.basePath}/insights/script.js`)
...
function je(e, a) {
  ...
  if (a)
    try {
      t = { ...((s = JSON.parse(a)) == null ? void 0 : s.analytics), ...e };
    } catch {}
  Oe(t.mode);
  const o = { sdkn: Ce + (t.framework ? `/${t.framework}` : ""), sdkv: Re };
  return (
    t.disableAutoTrack && (o.disableAutoTrack = "1"),
    t.viewEndpoint && (o.viewEndpoint = P(t.viewEndpoint)),
    t.eventEndpoint && (o.eventEndpoint = P(t.eventEndpoint)),
    t.sessionEndpoint && (o.sessionEndpoint = P(t.sessionEndpoint)),
    q() && t.debug === !1 && (o.debug = "false"),
    t.dsn && (o.dsn = t.dsn),
    t.endpoint
      ? (o.endpoint = t.endpoint)
      : t.basePath && (o.endpoint = P(`${t.basePath}/insights`)),
    { beforeSend: t.beforeSend, src: _e(t), dataset: o }
  );
}
function P(e) {
...
function Fe(e = { debug: !0 }, a) {
  var s;
  if (!de()) return;
  const { beforeSend: t, src: o, dataset: n } = je(e, a);
  if (
    (Pe(),
    t && ((s = window.va) == null || s.call(window, "beforeSend", t)),
    document.head.querySelector(`script[src*="${o}"]`))
  )
    return;
  const i = document.createElement("script");
  i.src = o;
  for (const [d, c] of Object.entries(n)) i.dataset[d] = c;
  ((i.defer = !0),
    (i.onerror = () => {
      const d = q()
      ...
      console.log(
        `[Vercel Web Analytics] Failed to load script from ${o}. ${d}`,
      );
    }),
    document.head.appendChild(i));
}
function We({ route: e, path: a }) {
  var s;
  (s = window.va) == null || s.call(window, "pageview", { route: e, path: a });
}
function Le() {
  if (!(typeof process > "u" || typeof D > "u"))
    return D.REACT_APP_VERCEL_OBSERVABILITY_BASEPATH;
}
function Me() {
  if (!(typeof process > "u" || typeof D > "u"))
    return D.REACT_APP_VERCEL_OBSERVABILITY_CLIENT_CONFIG;
}
function He(e) {
  return (
    l.useEffect(() => {
    ...
    l.useEffect(() => {
      e.route && e.path && We({ route: e.route, path: e.path });
    }, [e.route, e.path]),
    null
  );
}
...
const Be = [
    {
      ...
      title: "Sena",
      desc: "A design system built with AI end to end, turned into a production ReactJS library and a documentation hub. Eleven agents, one command.",
    ...
    },
    {
      ...
      desc: "A Figma plugin that watches the document as you design and renames frames the moment they appear — so Frame 12 and Group 5 never reach a handoff.",
    ...
    },
    {
      ...
      cmd: "journey analyse",
      title: "AI Journey",
      desc: "An analytics tool that does not just show that visitors leave — it explains why in plain language, suggests one specific fix, and later checks whether the fix worked.",
  ...
  $e = [
    {
      ...
      desc: "Most aspects of design and business, end-to-end, while shipping a product.",
      iso: "product",
    },
    {
      yr: "3",
      unit: "+ yrs",
      title: "AI Workflow",
      desc: "The loop between people and agents — prompts, tools and guardrails that ship.",
      iso: "ai",
    },
    {
      yr: "8",
      ...
      desc: "Systems that grow with the team and the product — tokens, components, docs.",
      iso: "system",
    },
  ],
  U = [
...
function mt(e) {
  if (
    ...
    e.STATS && e.STATS.length && (Qe = e.STATS),
    e.FOCUS && e.FOCUS.length && (Ze = e.FOCUS),
    e.AI_WORK && e.AI_WORK.length && (tt = e.AI_WORK),
    e.AI_TOOLS && e.AI_TOOLS.length)
  ) {
    const a = new Set(e.AI_TOOLS.map((n) => n.id)),
      s = U.filter((n) => !a.has(n.id)),
  ...
  if (
    (e.WORK_FEED && e.WORK_FEED.length && (st = e.WORK_FEED),
    e.COMPANIES && e.COMPANIES.length && (ot = e.COMPANIES),
    e.STREET_BRANDS && e.STREET_BRANDS.length && (nt = e.STREET_BRANDS),
  ...
  if (
    ...
    e.SCREENSHOTS && e.SCREENSHOTS.length && (rt = e.SCREENSHOTS),
    e.SITE && (lt = { ...he, ...e.SITE }),
...
function kt() {
  const e = ke(),
    ...
    [o, n] = l.useState(() =>
      O ? "Pleurat Shala" : ne(window.location.pathname),
    ),
    [i, d] = l.useState(O),
    [c, u] = l.useState(O),
    p = l.useRef(null),
...
const St = [],
  ...
  Tt = l.lazy(() =>
    b(() => import("./UIKit-D8rdnxEG.js"), __vite__mapDeps([0, 1, 2, 3])),
  ),
  Et = l.lazy(() =>
    b(
  ...
  ie = {
    "/": {
      title: "Pleurat Shala — Product Designer and AI Product Builder",
      desc: "Pleurat Shala — product designer with 10+ years across SaaS, brand and design systems, now building AI-native workflows. Selected work, case studies and contact.",
    },
    "/work": {
      title: `Selected Work — ${T}`,
      desc: "Selected product, brand and design-system work — MindPath, Appello, ValueHut, Codex and Otee.",
    },
    "/ai": {
      title: `AI Workflow — ${T}`,
      desc: "How AI actually fits a product design practice — automation, research, analysis, code, prototyping, testing and MCP agent workflows, plus the products built that way.",
    },
    "/about": {
      title: `About — ${T}`,
      desc: "Ten years turning complex problems into products that feel obvious — from marketplace templates to lead product design and AI workflows.",
    },
    "/contact": {
      title: `Contact — ${T}`,
      desc: "Product design, design systems, brand and AI workflows — based in Pristina, working with teams everywhere. Get in touch.",
    },
    "/privacy": {
      title: `Privacy — ${T}`,
      desc: "What this site records while you read it, who receives it, and how to have it stopped.",
    },
  };
function k(e, a, s) {
    ...
    l.useEffect(() => {
      ...
      t ||
        (t = {
          ...
          desc: "Nothing is filed under that address. The robot is going through the drawers.",
        });
      ...
      if (
        ...
        k(
          'meta[name="robots"]',
          "content",
          n || s === "/ui" ? "noindex, nofollow" : "index, follow",
        ),
        k('meta[name="description"]', "content", t.desc),
        k('link[rel="canonical"]', "href", i),
        k('meta[property="og:title"]', "content", t.title),
        k('meta[property="og:description"]', "content", t.desc),
        k('meta[property="og:url"]', "content", i),
        k('meta[name="twitter:title"]', "content", t.title),
        k('meta[name="twitter:description"]', "content", t.desc),
        a.current)
      ) {
        a.current = !1;
        return;
      }
      ((u = (c = window.posthog) == null ? void 0 : c.capture) == null ||
        u.call(c, "$pageview"),
        (p = window.gtag) == null ||
          p.call(window, "event", "page_view", {
            ...
            children: r.jsx(l.Suspense, {
              ...
              children: r.jsxs(Se, {
                children: [
                  ...
                  r.jsx(v, { path: "/ui", element: r.jsx(Tt, {}) }),
...
let V = !1,
  M = !1;
async function H() {
  if (!(V || M || document.visibilityState === "hidden")) {
    M = !0;
    try {
      const e = await fetch("/build.json", { cache: "no-store" });
      if (e.ok) {
        const { id: a } = await e.json();
        a && a !== "mtka3xon" && (V = !0);
      }
    } catch {}
    M = !1;
...
function Lt(e) {
  ...
  if (
    ...
    return;
  const a =
    (n = (o = e.target) == null ? void 0 : o.closest) == null
      ? void 0
      : n.call(o, "a");
  if (!a) return;
...
function Mt() {
  (document.addEventListener("visibilitychange", () => {
    ...
    window.setInterval(H, Wt),
    document.addEventListener("click", Lt, !0));
}
const re = () => r.jsx(Ae, { children: r.jsx(Ft, {}) });
function Ht() {
  Mt();
  const e = ve.createRoot(document.getElementById("root"));
  e.render(re());
  {
    const a = performance.now();
    b(async () => {
      const { loadSanityContent: s } = await import("./cms-rOwzeFgs.js").then(
        (t) => t.c,
      );
      return { loadSanityContent: s };
    }, [])
      .then(({ loadSanityContent: s }) => s())
      .then((s) => {
        performance.now() - a > 1e4 ||
          (s && Object.keys(s).length && (mt(s), e.render(re())));
      })
      .catch(() => {});
  }
  try {
    (window.location.pathname.replace(/\/$/, "") === "/editor" ||
      ...
      b(() => import("./index-D8zjrZIf.js"), __vite__mapDeps([19, 20]))
        .then((t) => t.mountEditor())
        .catch(() => {});
  } catch {}
}
Ht();
