  ...
  return e.jsxs("div", {
    ...
    children: [
      ...
      e.jsxs("section", {
        ...
        children: [
          e.jsx(ne, {
            title: L(n.railTitle ?? ["Selected work", "*& explorations.*"]),
            sub: n.railIntro,
            hero: {
              meta: n.heroEyebrow,
              cta: {
      ...
      e.jsx(me, { title: n.ndaTitle, names: n.ndaNames ?? [] }),
      e.jsx(re, {
        shots: _,
        initialTab: "apps",
        tabs: [
          { key: "apps", label: n.galleryTabApps ?? "Apps" },
          { key: "web", label: n.galleryTabWeb ?? "Websites" },
        ],
        title: L(n.galleryHeading),
        sub: n.galleryIntro,
      }),
      e.jsx(ce, {
        entries: K,
        title: L(n.spotlightTitle ?? ["Working with *AI.*"]),
        sub: n.spotlightDesc,
      }),
      e.jsx(se, {
        email: R.email,
